...
<div class="row" >
    ...
    <form action="registration.php" id="form"  method="post" style="margin-top:5%; margin-bottom:5%;padding:15%;">
      <h2 align="center" style="letter-spacing:2px;margin-top:-5%;">HELIX REGISTRATION FORM</h2>
        ...
        <div  class="select" style="margin-top:4%;">
                   ...
                   <select  required id="select_box" class="">
                   ...
                   <div id="Aravali_Institute_of_Technical_Studies" class="hide">
                     <p style="color:#000;">Attendees will be charged Rs.50 one-time registration fee at the venue. You will be rewarded with coupons worth Rs.50.</p>
                   </div>
                   ...
                   <div id="Sunrise_Group_of_Institutions" class="hide">
                     <p style="color:#000;">Attendees will be charged Rs.50 one-time registration fee at the venue.</p>
                   </div>
                              ...
                              <select  required id="gender" class="" required>
                                ...
                                <option style="background-color:#242831;color:#fff;" value="Other" for="3">Other</option>
                                       ...
                                       <h4 style="font-weight:normal;color:#242831;"> <span style="color:red;"> * </span> Attendees will be provided physical passes at the venue.</h4>
                                           ...
                                           <h4 style="font-weight:normal;color:#242831;"> <span style="color:red;"> * </span> Accomodation charges are Rs. 100/- per day. </h4>
